...
@router.post("/analyzer/yolo/find_missing")
async def analyzer_yolo_find_missing():
    # init variables
    logger.info("analyzer_yolo_find_missing")
    ...
    try:
        ...
        fpath = "src/analyzer/yolo_find_missing_data.py"
        fname = "yolo_find_missing_data.py"
